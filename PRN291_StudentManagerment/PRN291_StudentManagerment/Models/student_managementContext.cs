...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("server=CODEWITHHAO\\SQLEXPRESS; database=student_management;uid=sa;password=123");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Grade>(entity =>
            {
                ...
                entity.HasOne(d => d.GradeCategory)
                    ...
                    .HasConstraintName("FK__grade__grade_cat__3C69FB99");
            });
            ...
            modelBuilder.Entity<Schedule>(entity =>
            {
                ...
                entity.HasOne(d => d.Lecturer)
                    ...
                    .HasConstraintName("FK__schedule__lectur__4222D4EF");

                entity.HasOne(d => d.Room)
                    .WithMany(p => p.Schedules)
                    .HasForeignKey(d => d.RoomId)
                    .HasConstraintName("FK__schedule__room_i__403A8C7D");

                entity.HasOne(d => d.Slot)
                    .WithMany(p => p.Schedules)
                    .HasForeignKey(d => d.SlotId)
                    .HasConstraintName("FK__schedule__slot_i__412EB0B6");
            });
            ...
            modelBuilder.Entity<Student>(entity =>
            {
                ...
                entity.HasOne(d => d.Class)
                    ...
                    .HasForeignKey(d => d.ClassId)
                    .HasConstraintName("FK__student__class_i__38996AB5");
            });
            ...
            modelBuilder.Entity<StudentAttended>(entity =>
            {
                ...
                entity.HasOne(d => d.Schedule)
                    ...
                    .HasConstraintName("FK__student_a__sched__440B1D61");

                entity.HasOne(d => d.Student)
                    .WithMany(p => p.StudentAttendeds)
                    .HasForeignKey(d => d.StudentId)
                    .HasConstraintName("FK__student_a__stude__44FF419A");
            });
            ...
            modelBuilder.Entity<StudentGrade>(entity =>
            {
                ...
                entity.HasOne(d => d.Grade)
                    ...
                    .HasConstraintName("FK__student_g__grade__3F466844");

                entity.HasOne(d => d.Student)
                    .WithMany()
                    .HasForeignKey(d => d.StudentId)
                    .HasConstraintName("FK__student_g__stude__3D5E1FD2");

                entity.HasOne(d => d.Subject)
                    .WithMany()
                    .HasForeignKey(d => d.SubjectId)
                    .HasConstraintName("FK__student_g__subje__3E52440B");
            });
            ...
            modelBuilder.Entity<Subject>(entity =>
            {
                ...
                entity.HasOne(d => d.Class)
                    ...
                    .HasForeignKey(d => d.ClassId)
                    .HasConstraintName("FK__subject__class_i__3B75D760");

                entity.HasOne(d => d.Semester)
                    .WithMany(p => p.Subjects)
                    .HasForeignKey(d => d.SemesterId)
                    .HasConstraintName("FK__subject__semeste__3A81B327");
            });
